...
const geocode = (address, callback) => {
    ...
    //const url = 'https://api.mapbox.com/geocoding/v5/mapbox.places/' + address + '.json?access_token=pk.eyJ1IjoiZmFwYWwiLCJhIjoiY2szZnduaHg5MDhxczNjcDd1Y240eTNlcCJ9.nhFcKkRrKcqoL2nMqOfHEg&limit=1'
